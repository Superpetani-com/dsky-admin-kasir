<div class="modal fade" id="modal-form-barang" tabindex="-1" role="dialog" aria-labelledby="modal-form-barang">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('laporan.indexBarang') }}" method="get" data-toggle="validator" class="form-horizontal">
