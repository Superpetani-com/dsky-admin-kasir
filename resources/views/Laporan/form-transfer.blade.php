<div class="modal fade" id="modal-form-transfer" tabindex="-1" role="dialog" aria-labelledby="modal-form-transfer">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('laporan.indextransfer') }}" method="get" data-toggle="validator" class="form-horizontal">
