    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <a href="{{ route('laporan.export_pdfcafe', [$tanggalAwal, $tanggalAkhir]) }}" target="_blank" class="btn btn-success btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Export PDF</a>
