...
@section('breadcrumb')
    @parent
    <li class="active">LaporanTest</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <a href="{{ route('laporan.export_pdftest', [$tanggalAwal, $tanggalAkhir]) }}" target="_blank" class="btn btn-success btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Export PDF</a>
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('laporan.datatest', [$tanggalAwal, $tanggalAkhir]) }}',
            },
            columns: [
        ...
        cetak('{{ route('laporan.cetaktest', [$tanggalAwal, $tanggalAkhir]) }}', 'Nota');  
         });
    });
