      ...
      <table class="table table-order table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr >
              ...
              <td width=15%>
              <button type="button" onclick="resetform1('{{route('meja.reset', $item->id_meja)}}')" class="btn btn-xs btn-danger btn-flat btnr-{{$item->Status}}"><i class="fa fa-book"> </i> Selesai</button>
              </td>
            </tr>
            @endforeach
          </tbody>
